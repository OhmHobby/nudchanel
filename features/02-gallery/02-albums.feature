...
Feature: Gallery albums
  ...
  Scenario: Create album
    ...
    And albums should be
      | title    | cover     | coverUrl                                                                            | published | publishedAt |
      | Test E2E | undefined | https://photos.nudchannel.com/photos/cover/00000000-0000-0000-0000-000000000000.jpg | false     | undefined   |
  ...
  Scenario: Edit album
    ...
    Then HTTP response status should be OK
    And albums should be
      | id      | title             | cover     | coverUrl                                                                            | published |
      | BaVRIkb | Test E2E (edited) | undefined | https://photos.nudchannel.com/photos/cover/00000000-0000-0000-0000-000000000000.jpg | false     |
