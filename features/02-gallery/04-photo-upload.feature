...
Feature: Gallery album photo upload
  ...
  Scenario: Upload album photo
    ...
    When wait for gallery album "obo2m_X" upload photo file "IMG_2669.jpg" to be "accepted" state
    Then gallery album photos should contain
      | state    | width | height | timestamp                | color   | md5                              | takenBy.profileId        | directory                  | filename     |
      | accepted | 6000  | 4000   | 2022-05-29T01:29:51.000Z | #9f5827 | 5be8733fe975ea3ac49a81c37460ab9f | 5f26d84604f18f00186e4101 | /2023/test/(Erk) AnanyochS | IMG_2669.jpg |
  ...
  Scenario: Upload album photo - low resolution
    ...
    When wait for gallery album "obo2m_X" upload photo file "P8020704.jpg" to be "rejected" state
    Then gallery album photos should contain
      | state    | rejectReason | width | height | timestamp                | md5                              | takenBy.profileId        | directory                  | filename     |
  ...
  Scenario: Upload album photo - invalid timestamp
    ...
    When wait for gallery album "obo2m_X" upload photo file "P1448472.jpeg" to be "rejected" state
    Then gallery album photos should contain
      | state    | rejectReason | width | height | timestamp                | md5                              | takenBy.profileId        | directory                  | filename      |
  ...
  Scenario: Upload album photo - corrupt file
    ...
    When wait for gallery album "obo2m_X" upload photo file "IMG_6490.jpg" to be "failed" state
    Then gallery album photos should contain
  ...
  Scenario: Upload album photo - 0 bytes file
    ...
    When wait for gallery album "obo2m_X" upload photo file "IMG_2001.jpg" to be "failed" state
    Then gallery album photos should contain
      | state  | errorMessage | width     | height    | timestamp | md5                              | takenBy.profileId        | directory                  | filename     |
